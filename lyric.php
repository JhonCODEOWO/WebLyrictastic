...
//Fuente de origen para el boton de retornar
$source = $_GET['s'];
...
<main class="contenedor margin-top-contenedor">
    <button id="returnButton">PRUEBA DE BOTON</button>
    <?php if($source == "discover"){ ?>
        <a href="discover.php" class="enlace-btn return-button" id="returnButton">
